-- StudySync MariaDB initialization script
-- Date: 2026-05-06
--
-- Run this once with a privileged account in HeidiSQL.
-- It creates:
--   1. StudySync database
--   2. development DB user: admin / 1234
--   3. StudySync schema tables
--
-- Security note:
--   admin / 1234 is for local/team development only.
...
GRANT ALL PRIVILEGES ON StudySync.* TO 'admin'@'%';
GRANT ALL PRIVILEGES ON StudySync.* TO 'admin'@'localhost';
